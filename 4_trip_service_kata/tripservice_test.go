...
type MockUser struct {
	friends func() ([]User, error) // set it to control behavior
}

// implement Friender
func (mu MockUser) Friends() ([]User, error) {
	return mu.friends()
}
...
func (dao *MockDao) FindTripByUser(user Friender) ([]Trip, error) {
	return dao.findTrip()
}
